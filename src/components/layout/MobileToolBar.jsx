...
import { openCartCanvas } from '../../redux/action/cart';
import { openSearchBox } from '../../redux/action/searchBox';
    ...
    <>
      ...
      <div className='offcanvas__stikcy--toolbar'>
        <ul className='d-flex justify-content-between'>
          ...
          <li className='offcanvas__stikcy--toolbar__list'>
            <Link className='offcanvas__stikcy--toolbar__btn' to={isLogin ? '/profile' : '/login'}>
              <span className='offcanvas__stikcy--toolbar__icon'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='26.51'
