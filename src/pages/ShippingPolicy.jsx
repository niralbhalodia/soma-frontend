          ...
          <div className='row row-cols-1 ML-20'>
            <div className='col'>
              <ul className='breadcrumb__content--menu d-flex '>
                ...
                <li className='breadcrumb__content--menu__items'>
                  <span className='text-red'>Shipping-Policy</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className='row'>
              <div className='col-12'>
                ...
                <div className='privacy__policy--content section_3'>
                  <h2 className='privacy__policy--content__title'>How long we retain your data</h2>
                  <p className='privacy__policy--content__desc'>
                ...
                <div className='privacy__policy--content section_3'>
                  <h2 className='privacy__policy--content__title'>Where we send your data</h2>
                  <p className='privacy__policy--content__desc'>
